              ...
              <div key={t.id} className="admin-surface p-5 rounded-2xl space-y-3 border border-white/10">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-3">
                  ...
                  <div className="flex items-center gap-2">
                    {t.assignedTo && (
                      <span className="text-[10px] px-2.5 py-1 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 font-bold">
                ...
                <div className="flex justify-end pt-2">
                  ...
                  >
                    <span>✉️</span> {t.replyText ? "Update Reply" : "Reply to Customer"}
                  </button>
                </div>
              </div>
            ))}
            ...
            <div className="bg-[#0b1329] border border-white/15 rounded-3xl p-6 max-w-lg w-full shadow-2xl space-y-4">
              ...
              <form onSubmit={handleSendReply} className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  >
                    {submitting ? "Sending..." : "Send Email Reply 🚀"}
                  </button>
                </div>
              </form>
            </div>
