...
export default function SubAdminSettings() {
  ...
  return (
    <SubAdminAccessGuard moduleKey="settings">
      <div className="space-y-6 max-w-5xl mx-auto pb-12">
        {/* HEADER */}
        <div>
          <p className="admin-kicker text-cyan-300">Account Security & Credentials Desk</p>
          <h1 className="admin-title flex items-center gap-2">
            <ShieldCheckIcon className="w-8 h-8 text-cyan-400" />
            <span>Multi-Factor Authentication & Passkeys Suite (Version 3.1)</span>
          </h1>
          <p className="admin-lead">Configure Google Authenticator and Mobile / Laptop Biometric Passkeys for 1-click login security.</p>
        </div>
