 ...
 * Returns { draftId, lastSaved, saving, saveDraftManually }
 */
export function useAutoSave(formData, type, adminEmail, intervalMs = 10000) {
  ...
  useEffect(() => {
    ...
    const hasContent = formData && Object.values(formData).some((v) => {
