...
export function buildBaseMetadata({
  ...
  return {
    ...
    verification: {
      google: process.env.NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION || "GOOGLE_SEARCH_CONSOLE_VERIFICATION_PLACEHOLDER",
      yandex: process.env.NEXT_PUBLIC_YANDEX_SITE_VERIFICATION || "YANDEX_WEBMASTER_VERIFICATION_PLACEHOLDER",
      other: {
        "msvalidate.01": process.env.NEXT_PUBLIC_BING_SITE_VERIFICATION || "BING_WEBMASTER_VERIFICATION_PLACEHOLDER",
      },
    },
  };
}
